...
std::vector<syntaxNode*> itterateArguments(syntaxNode * parentNode, std::vector<syntaxNode*> & arguments, syntaxNode * userFunction = new syntaxNode());  //itterate through arguments
